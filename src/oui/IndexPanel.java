...
public class IndexPanel extends JPanel implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		Thread t = new Thread(new Runnable() {
			...
			public void run() {
				try {
					if(comboIndices.getSelectedIndex() == 0){	//dropdown chon agar kuchh ni select kita
					...
					JOptionPane.showMessageDialog(obj, "Index created successfully");	// obj che apne aap nu pass krta so that progressBar di value update hundi rawe
